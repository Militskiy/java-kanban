...
public class FileBackedTasksManager extends InMemoryTaskManager {
    public static void main(String[] args) {
        System.out.println("\n" + "Loading data generated by Main");
        FileBackedTasksManager tasksManager = loadFromFile(Path.of(DEFAULT_FILE_PATH));
        System.out.println("\n" + "List tasks");
        tasksManager.listEveryTaskAndEpicAndSubtask().forEach(System.out::println);
        System.out.println("\n" + "List prioritized tasks");
        tasksManager.listPrioritizedTasks().forEach(System.out::println);
        System.out.println("\n" + "List history");
        tasksManager.historyManager.getHistory().forEach(System.out::println);
    }
