...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Epic epic2 = new Epic(null, TaskType.EPIC, "Epic-2", "New Epic-2", null, 0);
        taskManager.addEpic(epic2);
        Subtask subtask1 = new Subtask(null, TaskType.SUBTASK, "Subtask-1", "New Subtask-1",
                Status.NEW, epic1, LocalDateTime.of(2022, 7, 21, 23, 11), 600);
        taskManager.addSubTask(subtask1);
        Subtask subtask2 = new Subtask(null, TaskType.SUBTASK, "Subtask-2", "New Subtask-2",
                Status.NEW, epic1, LocalDateTime.of(2022, 7, 21, 23, 13), 600);
